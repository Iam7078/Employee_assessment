        ...
        <div class="min-height-200px">
            <div class="page-header">
                <div class="row">
                    <div class="col-md-6 col-sm-12">
                        <div class="title">
                            <h4>Senior GM Assessment Result</h4>
                        </div>
            ...
            <div class="pd-20 card-box mb-30">
                <div class="clearfix mb-10 text-center align-items-center">
                    <h4 class="text-black h3">TIMW Employee Senior General Manager Assessment Results</h4>
                </div>
...
<script>
    function toggleClasses() {
        var iaElements = document.querySelectorAll('.DGM');
...
<script src="<?= base_url() ?>assessmentJs/data_result_senior_gm_view.js"></script>
