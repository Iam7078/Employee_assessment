        ...
        <div class="min-height-200px">
            ...
            <div class="pd-20 card-box mb-30">
                <div class="clearfix mb-10 text-center align-items-center">
                    <h4 class="text-black h3">TIMW Employee Self-Assessment Results</h4>
                </div>
...
<script>
    function toggleClasses() {
        var iaElements = document.querySelectorAll('.DSA');
...
<script src="<?= base_url() ?>assessmentJs/data_result_self_view.js"></script>
