        ...
        <div class="min-height-200px">
            <div class="page-header">
                <div class="row">
                    <div class="col-md-6 col-sm-12">
                        <div class="title">
                            <h4>Subordinate Assessment Detail</h4>
                        </div>
            ...
            <div class="pd-20 card-box mb-30">
                <div class="clearfix mb-30 align-items-center text-center">
                    <h4 class="text-black h3">Assessment of TIMW Employee Subordinates
                        <?= $year; ?>
                    </h4>
                </div>
...
<script src="<?= base_url() ?>assessmentJs/assess_leader_assessment_detail_view.js"></script>
