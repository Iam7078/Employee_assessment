        ...
        <div class="min-height-200px">
            ...
            <div class="pd-20 card-box mb-30">
                <div class="clearfix mb-20 d-flex justify-content-between align-items-center">
                    <h4 class="text-black h3">Account Data</h4>
                    <div class="d-flex ml-auto">
                        <button id="btn-import-excel" type="button" class="btn btn-success mr-2"><i
                                class="mr-1 fa fa-file-excel-o"></i> Excel</button>
                        <button data-toggle="modal" data-target="#bd-add" type="button" class="btn btn-danger"><i
                                class="mr-1 fa fa-plus"></i> Add</button>
                    </div>
                </div>
                <div class="table-responsive">
                    <table class="data-table table stripe hover nowrap tabel-account" id="dataTable">
                        <thead>
                            <tr>
                                <th>No</th>
                                <th>User Name</th>
...
<!-- Modal Add Data -->
<div class="modal fade bs-example-modal-lg" id="bd-add" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel"
    aria-hidden="true">
    <div class="modal-dialog modal-lg modal-dialog-centered">
        <div class="modal-content">
            <div class="modal-header">
                <h4 class="modal-title" id="myLargeModalLabel">Add Account Data</h4>
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group">
                                <label class="text-gray-800" for="user_name">User Name</label>
                                <input type="text" class="form-control" id="inputName">
                            </div>
                            <div class="form-group">
                                <label class="text-gray-800" for="user_id">User Id</label>
                                <input type="text" class="form-control" id="inputId">
                            </div>
                            <div class="form-group">
                                <label class="text-gray-800" for="role">Role</label>
...
<div class="modal fade bs-example-modal-lg" id="bd-example-modal-lg" tabindex="-1" role="dialog"
    ...
    <div class="modal-dialog modal-lg modal-dialog-centered">
        <div class="modal-content">
            <div class="modal-header">
                <h4 class="modal-title" id="myLargeModalLabel">Edit Account Data</h4>
                ...
                <form id="editItemForm">
                    <div class="row">
                        <div class="col-md-6">
                            ...
                            <div class="form-group">
                                <label class="text-gray-800" for="role">Role</label>
                                <input type="text" class="form-control" id="role_input">
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="form-group">
...
<script>
    function toggleClasses() {
        var iaElements = document.querySelectorAll('.DAC');
...
<script src="<?= base_url() ?>assessmentJs/data_account_view.js"></script>
