...
function getDataSeniorAssessment(id) {
    $.ajax({
        url: '/data-tabel-senior-assessment?employee_id=' + id,
        method: 'GET',
        dataType: 'json',
        success: function (response) {
