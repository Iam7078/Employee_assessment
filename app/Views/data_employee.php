        ...
        <div class="min-height-200px">
            ...
            <div class="pd-20 card-box mb-30">
                <div class="clearfix mb-20 d-flex justify-content-between align-items-center">
                    <h4 class="text-black h3">Employee Data</h4>
    ...
    <div class="modal-dialog modal-lg modal-dialog-centered">
        <div class="modal-content">
            <div class="modal-header">
                <h4 class="modal-title" id="myLargeModalLabel">Add Employee Data</h4>
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group">
                                <label class="text-gray-800" for="employee_name">Employee Name</label>
                                <input type="text" class="form-control" id="inputName">
                            </div>
                            <div class="form-group">
                                <label class="text-gray-800" for="employee_id">Employee Id</label>
                                <input type="text" class="form-control" id="inputId">
                            </div>
                            <div class="form-group">
                                <label class="text-gray-800" for="department">Department</label>
                                <input type="text" class="form-control" id="inputDepartment">
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="form-group">
                                <label class="text-gray-800" for="unit">Unit</label>
                                <input type="text" class="form-control" id="inputUnit">
                            </div>
                            <div class="form-group">
                                <label class="text-gray-800" for="direct_leader">Direct Leader</label>
                                <input type="text" class="form-control" id="inputDirectLeader">
                            </div>
                        </div>
                    </div>
                </form>
...
<div class="modal fade bs-example-modal-lg" id="bd-example-modal-lg" tabindex="-1" role="dialog"
    ...
    <div class="modal-dialog modal-lg modal-dialog-centered">
        <div class="modal-content">
            <div class="modal-header">
                <h4 class="modal-title" id="myLargeModalLabel">Edit Employee Data</h4>
                ...
                <form id="editItemForm">
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group">
                                <label class="text-gray-800" for="employee_name">Employee Name</label>
                                <input type="text" class="form-control" id="employee_name_input">
                            </div>
                            <div class="form-group">
                                <label class="text-gray-800" for="employee_id">Employee Id</label>
                                <input type="text" class="form-control" id="employee_id_input">
                            </div>
                            <div class="form-group">
                                <label class="text-gray-800" for="department">Department</label>
                                <input type="text" class="form-control" id="department_input">
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="form-group">
                                <label class="text-gray-800" for="unit">Unit</label>
                                <input type="text" class="form-control" id="unit_input">
                            </div>
                            <div class="form-group">
                                <label class="text-gray-800" for="direct_leader">Direct Leader</label>
                                <input type="text" class="form-control" id="direct_leader_input">
                            </div>
                        </div>
                    </div>
                </form>
...
<script>
    function toggleClasses() {
        var iaElements = document.querySelectorAll('.DEM');
...
<script src="<?= base_url() ?>assessmentJs/data_employee_view.js"></script>
